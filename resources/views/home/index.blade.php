...
<div class="main-wrapper">
    ...
    <div class="hero-section section">
        ...
        <div class="hero-slider hero-slider-one fix">
            ...
            <!-- Hero Item Start -->
            <div class="hero-item" style="background-image: url(frontend/assets/images/hero/hero-2.jpg)">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
                    ...
                    <div class="product-item">
                        <div class="product-inner">
                            ...
                            <div class="image">
                                <img src="{{ asset('frontend/assets/images/product/product-2.jpg') }}" alt="">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
                    ...
                    <div class="product-item">
                        <div class="product-inner">
                            ...
                            <div class="image">
                                <img src="{{ asset('frontend/assets/images/product/product-4.jpg') }}" alt="">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
                    ...
                    <div class="product-item">
                        <div class="product-inner">
                            ...
                            <div class="image">
                                <img src="{{ asset('frontend/assets/images/product/product-5.jpg') }}" alt="">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
                    ...
                    <div class="product-item">
                        <div class="product-inner">
                            ...
                            <div class="image">
                                <img src="{{ asset('frontend/assets/images/product/product-7.jpg') }}" alt="">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
                    ...
                    <div class="product-item">
                        <div class="product-inner">
                            ...
                            <div class="image">
                                <img src="{{ asset('frontend/assets/images/product/product-8.jpg') }}" alt="">
