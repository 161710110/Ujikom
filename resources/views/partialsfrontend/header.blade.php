              ...
              <ul>
                ...
                <li class="cart-icon"> 
                  ...
                  <div class="cart-dropdown header-link-dropdown">
                    ...
                    <div class="mt-20"> <a href="cart.html" class="btn-color btn">Cart</a> <a href="{{ url('/checkout') }}" class="btn-color btn right-side">Checkout</a> </div>
                  </div>
                </li>
            ...
            <div class="bottom-inner">
              <div class="position-r">          
                <div class="nav_sec position-r">
                  ...
                  @include('partialsfrontend.navbarmenu')
                </div>
              </div>
            </div>
          </div>
