                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-group">
                      <input type="hidden" name="id" id="id">
                        ...
                        <input type="text" name="nama_merk" id="nama_merk" class="form-control" placeholder="Cussons" />
                     ...
                     <div class="form-group">
                      <input type="hidden" name="id" id="id">
                        <label>Foto</label>
                        <input type="text" name="foto" id="foto" class="form-control" placeholder="Cussons" />
